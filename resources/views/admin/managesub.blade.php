...
<li> 
    ...
    <ul id="sub-list" class="collapse list-unstyled">
        ...
        <li class="active"> <a href="{{ route('admin.manage.subs') }}">Manage Subscribers</a></li>
...
<section class="dashboard-header section-padding">
    <div class="container-fluid">
        ...
        <br>
        <table id="subTable" class="table table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                <tr class="sub-row" data-id="{{ $sub->id }}">
                    <td>{{ $sub->idnum }}</td>
                    <td>{{ $sub->firstname }} {{ $sub->middlename }} {{ $sub->lastname }} {{ $sub->suffix }}</td>
                    <td>{{ $sub->college }}</td>
                </tr>
                @endforeach
            </tbody>
